                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Reservation Management
                            <a href="${pageContext.request.contextPath}/reservations/new" class="btn btn-primary float-right">Add New Reservation</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <c:forEach var="reservation" items="${reservationList}">
                                    <tr>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/clients/view?id=${reservation.client.idClient}">
                                                ${reservation.client.FNameClient} ${reservation.client.LNameClient}
                                            </a>
                                        </td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/tables/view?id=${reservation.table.idTab}">
                                                Table #${reservation.table.idTab} (${reservation.table.nbrPlace} seats)
                                            </a>
                                        </td>
                                        <td><fmt:formatDate value="${reservation.dateReservation}" pattern="yyyy-MM-dd" /></td>
                                        <td><fmt:formatDate value="${reservation.heureDebutReservation}" pattern="HH:mm" /></td>
                                        <td><fmt:formatDate value="${reservation.heureFinReservation}" pattern="HH:mm" /></td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/reservations/view?clientId=${reservation.client.idClient}&tableId=${reservation.table.idTab}" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/reservations/edit?clientId=${reservation.client.idClient}&tableId=${reservation.table.idTab}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/reservations/delete?clientId=${reservation.client.idClient}&tableId=${reservation.table.idTab}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this reservation?')">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="calendar-controls text-center mb-3">
                            <div class="btn-group">
                                <button id="prevWeek" class="btn btn-outline-secondary"><i class="fas fa-chevron-left"></i> Previous</button>
                                <button id="todayBtn" class="btn btn-outline-primary">Today</button>
                                <button id="nextWeek" class="btn btn-outline-secondary">Next <i class="fas fa-chevron-right"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="calendar-header">
                            <div class="row">
                                ...
                                <div class="col-md text-center font-weight-bold">Wednesday</div>
                                <div class="col-md text-center font-weight-bold">Thursday</div>
                                <div class="col-md text-center font-weight-bold">Friday</div>
                                <div class="col-md text-center font-weight-bold">Saturday</div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#filterBtn").click(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/reservations/list?date=" + selectedDate;
            });
        ...
        function populateCalendarDates() {
            ...
            var reservationContainers = document.querySelectorAll('.reservations-container');
