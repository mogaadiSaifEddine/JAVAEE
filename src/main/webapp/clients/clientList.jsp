                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Client Management
                            <a href="${pageContext.request.contextPath}/clients/new" class="btn btn-primary float-right">Add New Client</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <c:forEach var="client" items="${clientList}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/clients/view?id=<c:out value='${client.idClient}' />" class="btn btn-info btn-sm">View</a>
                                            <a href="${pageContext.request.contextPath}/clients/edit?id=<c:out value='${client.idClient}' />" class="btn btn-primary btn-sm">Edit</a>
                                            <a href="${pageContext.request.contextPath}/clients/delete?id=<c:out value='${client.idClient}' />" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this client?')">Delete</a>
                                            <a href="${pageContext.request.contextPath}/reservations/client?clientId=<c:out value='${client.idClient}' />" class="btn btn-success btn-sm">Reservations</a>
                                            <a href="${pageContext.request.contextPath}/commandes/client?clientId=<c:out value='${client.idClient}' />" class="btn btn-warning btn-sm">Orders</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
