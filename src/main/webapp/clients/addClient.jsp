        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/clients/insert" method="post">
                            ...
                            <a href="${pageContext.request.contextPath}/clients/list" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
