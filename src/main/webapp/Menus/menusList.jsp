                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <c:if test="${not empty menu.plats}">
                          ...
                          <div class="mt-3">
                            <strong
                              >Total Price: $<fmt:formatNumber
                                value="${menu.plats.stream().map(p -> p.prixPlat).sum()}"
                                pattern="#0.00"
                            /></strong>
                          </div>
                        </c:if>
                      ...
                      <div class="card-footer">
                        <a
                          href="${pageContext.request.contextPath}/menus/view?id=${menu.idMenu}"
                          class="btn btn-info btn-sm"
                        >
                          <i class="fas fa-eye"></i> View
                        </a>
                        <a
                          href="${pageContext.request.contextPath}/menus/edit?id=${menu.idMenu}"
                          class="btn btn-primary btn-sm"
                        >
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a
                          href="${pageContext.request.contextPath}/menus/delete?id=${menu.idMenu}"
